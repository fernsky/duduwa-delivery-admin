...
class MajorSkillsProcessor(BaseEconomicsProcessor):
    ...
    class MajorSkillsReportFormatter(BaseEconomicsReportFormatter):
        ...
        def generate_formal_report(self, skills_data, ward_data, total_population):
            ...
            content.append(
                f"""डुडुवा गाउँपालिकामा कुल {nepali_total} जनसंख्यासँग विभिन्न सीप र कौशलताहरू छन् । मुख्य सीपका आधारमा जनसंख्याको वितरण गर्दा गाउँपालिकाको मानव संसाधनको गुणस्तर र आर्थिक क्षमताको अवस्था देखिन्छ ।"""
            )
