    ...
    class WardWiseHouseOuterWallReportFormatter(BaseEconomicsReportFormatter):
        def generate_formal_report(
            ...
            if used_types:
                ...
                main_sentence = (
                    f"डुडुवा गाउँपालिकामा बाहिरी गारोको आधारमा घरधुरीको विवरण हेर्दा, कुल {format_nepali_number(total_households)} घरधुरीमध्ये "
                    + "; ".join(type_strs)
                    + " रहेका छन् ।"
                )
            else:
                main_sentence = (
                    f"डुडुवा गाउँपालिकामा बाहिरी गारोको आधारमा कुनै घरधुरी विवरण उपलब्ध छैन ।"
                )
            # Compose analysis
            traditional = [
                c
