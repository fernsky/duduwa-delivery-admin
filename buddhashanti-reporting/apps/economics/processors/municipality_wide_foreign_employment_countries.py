...
class MunicipalityWideForeignEmploymentCountriesProcessor(BaseEconomicsProcessor):
    ...
    class MunicipalityWideForeignEmploymentCountriesReportFormatter(
        ...
        def generate_formal_report(self, country_data, total_population):
            ...
            if not country_data:
                return (
                    "यस खण्डमा कुनै वैदेशिक रोजगारीको तथ्यांक उपलब्ध छैन। डुडुवा गाउँपालिकाका "
            ...
            analysis_parts.append(
                f"डुडुवा गाउँपालिकाको जनसंख्या तथ्यांक विश्लेषण गर्दा वैदेशिक रोजगारीको क्षेत्रमा "
            ...
            if total_countries > 10:
                ...
                analysis_parts.append(
                    f"वैदेशिक रोजगारी गन्तव्यको विविधताको सन्दर्भमा, डुडुवा गाउँपालिकाका नागरिकहरूले "
            ...
            analysis_parts.append(
                f"यो वैदेशिक रोजगारीको तथ्यांकले डुडुवा गाउँपालिकाको आर्थिक संरचनामा महत्त्वपूर्ण प्रभाव "
            ...
            # Concluding remarks
            analysis_parts.append(
                f"समग्रमा, डुडुवा गाउँपालिकाको वैदेशिक रोजगारीको अवस्थाले नेपालको राष्ट्रिय श्रम "
