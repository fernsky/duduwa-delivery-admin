...
class WardWiseHouseOwnershipProcessor(BaseEconomicsProcessor):
    ...
    class WardWiseHouseOwnershipReportFormatter(BaseEconomicsReportFormatter):
        def generate_formal_report(
            ...
            lines = [
                f"डुडुवा गाउँपालिकामा घरधुरी स्वामित्वको विश्लेषण गर्दा, कुल घरधुरीमध्ये {format_nepali_number(private_count)} ({private_pct}) निजी स्वामित्वमा रहेका छन्, जुन अत्यधिक बहुमत हो।",
