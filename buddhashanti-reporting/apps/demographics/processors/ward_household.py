    ...
    class WardHouseholdReportFormatter(BaseReportFormatter):
        ...
        def generate_formal_report(self, data):
            ...
            if not data or not data.get("ward_data"):
                return "डुडुवा गाउँपालिकाको वडागत घरपरिवारको तथ्याङ्क उपलब्ध छैन।"
            ...
            if not summary_stats:
                return "डुडुवा गाउँपालिकाको वडागत घरपरिवारको विश्लेषणका लागि पर्याप्त तथ्याङ्क उपलब्ध छैन।"

            analysis_parts = []

            # Overall introduction
            analysis_parts.append(
                f"डुडुवा गाउँपालिकाका {format_nepali_number(len(ward_data))} वडामा वर्ष {format_nepali_number(latest_year)} को तथ्याङ्क अनुसार कुल "
            ...
            analysis_parts.append(
                f"समग्रमा, डुडुवा गाउँपालिकाको वडागत घरपरिवार र जनसंख्या संरचनाले स्थानीय विकास, सेवा प्रवाह र योजना निर्माणमा महत्वपूर्ण आधार प्रदान गर्दछ। विस्तृत विवरण तलको तालिका र चित्रमा प्रस्तुत गरिएको छ।"
            )
