...
class RoadStatusProcessor(BaseInfrastructureProcessor):
    ...
    def generate_analysis_text(self, data):
        ...
        analysis_parts.append(
            f"डुडुवा गाउँपालिकामा कुल {format_nepali_number(total_households)} घरपरिवारको सडकको अवस्था विश्लेषण गर्दा विभिन्न प्रकारका सडक सुविधा उपलब्ध रहेको देखिन्छ।"
        )
