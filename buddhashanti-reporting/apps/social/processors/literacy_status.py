...
class LiteracyStatusProcessor(BaseSocialProcessor):
    ...
    def generate_analysis_text(self, data: Dict[str, Any]) -> str:
        ...
        content.append(
            f"""डुडुवा गाउँपालिकामा कुल {nepali_total} जनसंख्याको साक्षरता अवस्थाको विश्लेषण गर्दा शैक्षिक विकासको स्थिति र भविष्यका चुनौतीहरू स्पष्ट देखिन्छन् । साक्षरताका विभिन्न स्तरमा जनसंख्याको वितरणले गाउँपालिकाको मानव संसाधन विकासको अवस्थालाई प्रतिबिम्बित गर्छ ।"""
        )
