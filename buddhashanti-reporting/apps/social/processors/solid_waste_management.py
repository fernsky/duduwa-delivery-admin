...
class SolidWasteManagementProcessor(BaseSocialProcessor):
    ...
    def generate_analysis_text(self, data):
        ...
        analysis_parts.append(
            f"डुडुवा गाउँपालिकामा कुल {format_nepali_number(total_households)} घरपरिवारको ठोस फोहोर व्यवस्थापनको अवस्था विश्लेषण गर्दा विभिन्न विधिहरूको प्रयोग भइरहेको देखिन्छ।"
        )
