...
class MajorSubjectProcessor(BaseSocialProcessor):
    ...
    def generate_analysis_text(self, data):
        ...
        analysis_parts.append(
            f"डुडुवा गाउँपालिकामा पाँच वर्ष र सोभन्दा माथिका कुल {format_nepali_number(total_population)} जना जनसंख्याको शैक्षिक योग्यताको विश्लेषण गर्दा विभिन्न विषयहरूमा शिक्षा ग्रहण गरेको पाइन्छ।"
        )
