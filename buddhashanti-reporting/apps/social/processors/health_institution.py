...
class HealthInstitutionProcessor(BaseSocialProcessor):
    ...
    def generate_analysis_text(self, data: Dict[str, Any]) -> str:
        ...
        if not data or data["total_institutions"] == 0:
            return """डुडुवा गाउँपालिकामा स्वास्थ्य संस्थाको विवरण सम्बन्धी पर्याप्त तथ्यांक उपलब्ध छैन । स्वास्थ्य सेवाको पहुँच र गुणस्तर सुधारका लागि विस्तृत अध्ययन र तथ्यांक संकलन आवश्यक छ ।"""
        ...
        content.append(
            f"""डुडुवा गाउँपालिकामा कुल {nepali_total} स्वास्थ्य संस्थाहरूको विश्लेषण गर्दा स्वास्थ्य सेवाको पहुँच र वितरणको स्थिति स्पष्ट देखिन्छ । यी संस्थाहरूले गाउँपालिकाका नागरिकहरूलाई प्राथमिक देखि विशेषीकृत स्वास्थ्य सेवासम्म प्रदान गर्ने महत्वपूर्ण भूमिका खेल्छन् ।"""
        )
