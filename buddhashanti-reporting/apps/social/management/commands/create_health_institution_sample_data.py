...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        health_institution_data = [
            {"s_n": 1, "name": "पाङ डुडुवा चौकी", "ward_number": 1},
            {"s_n": 2, "name": "सिर्प डुडुवा चौकी", "ward_number": 2},
            {"s_n": 3, "name": "बडाचौर डुडुवा चौकी", "ward_number": 5},
            {"s_n": 4, "name": "गुम्चाल डुडुवा चौकी", "ward_number": 6},
            {"s_n": 5, "name": "हार्जङ डुडुवा चौकी", "ward_number": 7},
