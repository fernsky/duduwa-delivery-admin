...
<header class="main-header">
  <div class="header-brand">
    <img src="logo.png" alt="डुडुवा नगरपालिका" class="logo" />
    <div class="brand-text">
      <h1 class="municipality-name nepali-text">डुडुवा नगरपालिका</h1>
...
@media print {
  @page {
    ...
    @top-center {
      content: "डुडुवा नगरपालिका - डिजिटल प्रोफाइल प्रतिवेदन";
      font-size: 10pt;
      color: #666;
    }
