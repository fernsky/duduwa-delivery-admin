...
export const metadata: Metadata = {
  title: "नियम र शर्तहरू | डुडुवा गाउँपालिका",
  description: "डुडुवा गाउँपालिका डिजिटल प्रोफाइल प्रयोगका नियम र शर्तहरू",
};
  ...
  const termsSections = [
    {
      ...
      content: [
        "डुडुवा गाउँपालिकाको डिजिटल प्रोफाइल वेबसाइट प्रयोग गर्दा निम्न नियमहरू लागू हुनेछन्:",
    ...
    },
    {
      ...
      content: [
        ...
        "• लोगो, चित्र, ग्राफिक, लेआउट र डिजाइन डुडुवा गाउँपालिकाको स्वामित्वमा छन्",
    ...
    },
    {
      ...
      content: [
        "डुडुवा गाउँपालिका निम्न अवस्थाहरूमा जवाफदेही हुने छैन:",
    ...
    },
    {
      ...
      content: [
        "डुडुवा गाउँपालिकाले यी नियम र शर्तहरू परिवर्तन गर्ने अधिकार राख्दछ:",
        ...
        <div className="bg-gradient-to-r from-[#0b1f42] to-[#1a4894] py-16 md:py-24">
          ...
          <div className="container px-4 sm:px-6 max-w-5xl mx-auto relative z-10">
            ...
            <p className="text-white/90 text-lg max-w-3xl">
              डुडुवा गाउँपालिकाको डिजिटल प्रोफाइल सेवा प्रयोग गर्नु अघि कृपया यी
              नियम र शर्तहरू ध्यानपूर्वक पढ्नुहोस्। यी शर्तहरू स्वीकार गरेपछि
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-1 space-y-4">
              ...
              <p className="text-[#123772] font-medium">
                यो दस्तावेज कानूनी रूपमा बाध्यकारी सम्झौता हो जसले डुडुवा
