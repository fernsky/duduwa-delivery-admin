...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const municipalityNameEn = "duduwa Rural Municipality";
    ...
    return {
      ...
      openGraph: {
        ...
        images: [
          {
            url: "https://digital.duduwamun.gov.np/images/municipality-logo.png",
            width: 1200,
            height: 630,
      ...
      twitter: {
        ...
        description: descriptionNP,
        images: [
          "https://digital.duduwamun.gov.np/images/municipality-logo.png",
        ],
      },
    };
  } catch (error) {
    ...
    return {
      title: "डुडुवा गाउँपालिका | आधिकारिक वेबसाइट",
      description:
        "डुडुवा गाउँपालिका बाँके जिल्लाको एक प्रमुख स्थानीय तह हो। पालिकाको आधिकारिक वेबसाइटमा स्वागत छ।",
    };
  }
}
