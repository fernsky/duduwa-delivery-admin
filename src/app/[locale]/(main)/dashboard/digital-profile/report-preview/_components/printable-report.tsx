        ...
        <div className="main-content">
          ...
          <div className="category-break">
            ...
            <div className="section-content">
              ...
              <div className="content-section">
                <p>
                  यो अध्ययन डुडुवा गाउँपालिकाको समग्र विकासको लागि आवश्यक
          ...
          <div className="category-break">
            ...
            <div className="section-content">
              ...
              <div className="content-section">
                <p>
                  डुडुवा गाउँपालिका प्रदेश नं. १ को बाँके जिल्लामा अवस्थित छ। यो
                  गाउँपालिका कुल १० वटा वडाहरूमा विभाजित छ।
                </p>
              </div>
