...
export const metadata: Metadata = {
  title: "डुडुवा गाउँपालिका स्वास्थ्य अवस्था | डिजिटल प्रोफाइल",
  description:
    "डुडुवा गाउँपालिकाको स्वास्थ्य सम्बन्धी तथ्याङ्क: खोप सेवा, स्वास्थ्य बीमा र स्वास्थ्य संस्थाको पहुँच सम्बन्धी विस्तृत विवरण।",
  keywords: [
    "डुडुवा गाउँपालिका",
    "स्वास्थ्य अवस्था",
    "खोप सेवा",
...
const healthServiceCategories = [
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा खोप सेवा र कभरेजको अवस्था, विभिन्न खोपहरूको प्रगति र खोप सेवाको गुणस्तरको विस्तृत विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा स्वास्थ्य बीमा गरेका र नगरेका घरधुरीको वडागत विवरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा घरपरिवारले नजिकको स्वास्थ्य संस्थासम्म पुग्न लाग्ने समयको वडागत विवरण र विश्लेषण।",
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="relative rounded-lg overflow-hidden">
          <Image
            ...
            alt="डुडुवा गाउँपालिका स्वास्थ्य अवस्था"
            width={1200}
            height={400}
        ...
        <div className="mt-6 px-2">
          <h1 className="text-4xl font-bold mb-3">
            डुडुवा गाउँपालिकाको स्वास्थ्य अवस्था
          </h1>
        </div>
        ...
        <section id="introduction">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              ...
              महत्वपूर्ण सूचकहरू हुन्। डुडुवा गाउँपालिकाको स्वास्थ्य
        ...
        <section id="health-service-categories" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकाको स्वास्थ्य सेवा सम्बन्धी विस्तृत जानकारीका
        ...
        <section id="improvement-strategies" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकामा स्वास्थ्य सेवाको अवस्था सुधार गर्न निम्न
