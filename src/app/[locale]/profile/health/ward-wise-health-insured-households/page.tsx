...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका स्वास्थ्य बीमा",
    ...
    const keywordsEN = [
      "duduwa Rural Municipality health insurance",
    ...
    // Create description
    const descriptionNP = `डुडुवा गाउँपालिकामा स्वास्थ्य बीमा सम्बन्धी विश्लेषण। कुल ${localizeNumber(totalHouseholds.toLocaleString(), "ne")} घरधुरी मध्ये ${localizeNumber(insuredPercentage, "ne")}% (${localizeNumber(totalInsuredHouseholds.toLocaleString(), "ne")}) घरधुरीले स्वास्थ्य बीमा गरेका छन्।`;

    const descriptionEN = `Analysis of health insurance coverage in duduwa Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${insuredPercentage}% (${totalInsuredHouseholds.toLocaleString()}) households have health insurance.`;
    ...
    return {
      title:
        "स्वास्थ्य बीमा गरेका घरधुरीको अवस्था | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="स्वास्थ्य बीमा गरेका घरधुरीको अवस्था - डुडुवा गाउँपालिका (Health Insured Households - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा स्वास्थ्य बीमा गरेका घरधुरीको अवस्था
            </h1>
            ...
            <p>
              ...
              गर्दछ। यस खण्डमा डुडुवा गाउँपालिकाको विभिन्न वडाहरूमा
            ...
            <p>
              ...
              घरधुरी हो। यसले डुडुवा गाउँपालिकामा स्वास्थ्य बीमाको महत्व र
            ...
            <p>
              डुडुवा गाउँपालिकामा स्वास्थ्य बीमा गरेका र नगरेका घरधुरीको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा स्वास्थ्य बीमाको अवस्थाको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(insuredPercentage, "ne")}% घरधुरीले स्वास्थ्य बीमा
            ...
            <p>
              डुडुवा गाउँपालिकामा स्वास्थ्य बीमाको अवस्था विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              यसरी डुडुवा गाउँपालिकामा स्वास्थ्य बीमाको अवस्थाको विश्लेषणले
