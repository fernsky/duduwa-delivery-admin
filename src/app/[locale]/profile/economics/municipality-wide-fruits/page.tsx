...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका फलफूल बाली",
      "डुडुवा फलफूलको उत्पादन",
      "पालिका स्तरीय फलफूल बाली तथ्याङ्क",
      "आँप उत्पादन डुडुवा",
      "रुखकटहर उत्पादन तथ्याङ्क",
      "लिची उत्पादन",
      `डुडुवा फलफूल बाली बिक्री ${localizeNumber(totalSales.toFixed(2), "ne")} टन`,
      `डुडुवा फलफूल बाली आय ${localizeNumber((totalRevenue / 1000000).toFixed(2), "ne")} मिलियन`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality fruits",
      "duduwa fruit production",
      "Municipality-wide fruit statistics",
      "Mango production in duduwa",
      "Jackfruit cultivation statistics",
      "Litchi production data",
      `duduwa fruit sales ${totalSales.toFixed(2)} tonnes`,
      `duduwa fruit revenue ${(totalRevenue / 1000000).toFixed(2)} million rupees`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `डुडुवा गाउँपालिकाको फलफूल बाली उत्पादन र बिक्री विश्लेषण। कुल ${localizeNumber(totalProduction.toFixed(2), "ne")} मेट्रिक टन फलफूल बाली उत्पादन मध्ये ${localizeNumber(mostProducedPercentage, "ne")}% (${localizeNumber(mostProducedAmount.toFixed(2), "ne")} टन) ${FRUIT_TYPES[mostProducedFruit] || mostProducedFruit} रहेको छ। पालिका स्तरीय फलफूल बालीको विस्तृत विश्लेषण।`;

    const descriptionEN = `Analysis of fruit production and sales in duduwa Rural Municipality. Out of total ${totalProduction.toFixed(2)} metric tonnes of fruit production, ${mostProducedPercentage}% (${mostProducedAmount.toFixed(2)} tonnes) is ${FRUIT_TYPES_EN[mostProducedFruit] || mostProducedFruit}. Detailed analysis of municipality-wide fruit patterns.`;
    ...
    return {
      title:
        "फलफूल बालीको प्रकार अनुसार उत्पादन र बिक्री | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="फलफूल बालीको प्रकार अनुसार उत्पादन र बिक्री - डुडुवा गाउँपालिका (Fruits by Production and Sales - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा फलफूल बालीको प्रकार अनुसार उत्पादन र
              बिक्री
            </h1>
            ...
            <p>
              फलफूल बाली डुडुवा गाउँपालिकाको प्रमुख कृषि उत्पादनहरू मध्ये
            ...
            <p>
              डुडुवा गाउँपालिकाको फलफूल बाली सम्बन्धी तथ्याङ्क अनुसार, यस
            ...
            <p>
              डुडुवा गाउँपालिकामा उत्पादित प्रमुख फलफूल बालीहरू र तिनको
            ...
            <p>
              फलफूल बालीको विश्लेषण गर्दा, डुडुवा गाउँपालिकामा उत्पादित कुल
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा फलफूल बालीको उत्पादनले स्थानीय
            ...
            <p>
              डुडुवा गाउँपालिकाको प्रमुख फलफूल बालीको उत्पादकत्व र
            ...
            <p>
              डुडुवा गाउँपालिकाको फलफूल बालीको अवस्थाको विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              डुडुवा गाउँपालिकामा फलफूल बालीको वर्तमान अवस्थाले अझै विकासको
