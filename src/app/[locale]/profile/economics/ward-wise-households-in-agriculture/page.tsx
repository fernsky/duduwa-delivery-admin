...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "कृषि वा पशुपालनमा आबद्ध घरपरिवार | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="कृषि वा पशुपालनमा आबद्ध घरपरिवार - डुडुवा गाउँपालिका (Households Involved in Agriculture - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध घरपरिवारको वितरण
            </h1>
            ...
            <p>
              कृषि नेपालको अर्थतन्त्रको मेरुदण्ड हो र डुडुवा गाउँपालिकामा
            ...
            <p>
              डुडुवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध र आबद्ध नभएका
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध घरपरिवारको
            ...
            <p className="mt-6">
              यसरी डुडुवा गाउँपालिकामा कृषि वा पशुपालनमा आबद्ध घरपरिवारको
