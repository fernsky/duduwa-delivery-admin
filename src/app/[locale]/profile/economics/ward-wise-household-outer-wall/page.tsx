...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका घरको बाहिरी गारो",
      "डुडुवा घरको बाहिरी गारो वितरण",
      "वडा अनुसार घरको बाहिरी गारो",
      "घरको बाहिरी गारो विवरण",
      "सिमेन्टको जोडाइ भएको इँटा/ढुङ्गा",
      "माटोको जोडाइ भएको घरहरू",
      `डुडुवा घरको बाहिरी गारो संख्या ${localizeNumber(totalHouseholds.toString(), "ne")}`,
      "डुडुवा गृह सुरक्षा",
      "डुडुवा आवास संरचना",
    ];
    ...
    return {
      title:
        "घरको बाहिरी गारोको वितरण | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा घरको बाहिरी गारोको वितरण
            </h1>
            ...
            <p>
              ...
              खण्डमा डुडुवा गाउँपालिकामा घरको बाहिरी गारोका प्रमुख
              प्रकारहरू र तिनको वडागत वितरणको विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              डुडुवा गाउँपालिकाको घरको बाहिरी गारोको तथ्याङ्क अनुसार, कुल
            ...
            <p>
              डुडुवा गाउँपालिकामा घरको बाहिरी गारोका प्रमुख प्रकारहरू र
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा घरको बाहिरी गारोको वितरण विश्लेषणबाट
            ...
            <p>
              डुडुवा गाउँपालिकामा घरको बाहिरी गारोको समग्र अवस्था मध्यम
