...
export default function CooperativesAnalysisSection({
  ...
  return (
    <>
      ...
      <p className="mt-4">
        डुडुवा गाउँपालिकाका सहकारी संस्थाहरूले विभिन्न प्रकारका वित्तीय,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        <div className="border rounded-lg p-6 bg-muted/30">
          ...
          <p className="text-muted-foreground text-sm mb-4">
            डुडुवामा सबैभन्दा लोकप्रिय सहकारी प्रकार, जुन कुल सहकारीको
            {localizeNumber(
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        <h3 className="text-xl font-medium mb-6">
          ...
          <span className="sr-only">
            Detailed Cooperative Analysis of duduwa
          </span>
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Main Cooperative Types in duduwa Rural Municipality
              </span>
            </h4>
            {primaryCooperative && (
        ...
        <div className="mt-6 pt-4 border-t">
          ...
          <p className="text-sm">
            डुडुवा गाउँपालिकामा सञ्चालित सहकारी संस्थाहरूले स्थानीय
