...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "वडा अनुसार सिंचित र असिंचित क्षेत्रफल | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        "डुडुवा गाउँपालिकामा वडा अनुसार सिंचित र असिंचित क्षेत्रफलको विवरण र विश्लेषण।",
    };
  }
}
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वडा अनुसार सिंचित र असिंचित क्षेत्रफल - डुडुवा गाउँपालिका (Ward-wise Irrigated and Unirrigated Area - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा वडा अनुसार सिंचित र असिंचित क्षेत्रफल
            </h1>
            ...
            <p>
              ...
              डुडुवा गाउँपालिकामा वडागत रूपमा सिंचित र असिंचित क्षेत्रफलको
            ...
            <p>
              डुडुवा गाउँपालिकाका सबै वडाहरूमा सिंचाई सुविधाको वितरण असमान
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा सिंचाईको अवस्था विश्लेषण गर्दा कुल
              {localizeNumber(totalArea.toFixed(2), "ne")} हेक्टर क्षेत्रफल
              मध्ये
              {localizeNumber(totalUnirrigatedArea.toFixed(2), "ne")} हेक्टर (
            ...
            <p>
              डुडुवा गाउँपालिकाको वडागत सिंचित र असिंचित क्षेत्रफलको
            ...
            <p className="mt-6">
              डुडुवा गाउँपालिकामा सिंचाईको अवस्थालाई सुधार गर्न सम्पूर्ण
