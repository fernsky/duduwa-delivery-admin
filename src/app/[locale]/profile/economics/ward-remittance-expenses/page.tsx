...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका रेमिट्यान्स खर्च",
      "डुडुवा विप्रेषण उपयोग",
      `डुडुवा ${remittanceExpenseLabels[topExpenses[0] as RemittanceExpenseType]} खर्च`,
      ...topExpenses.map(
        (r) =>
          `${remittanceExpenseLabels[r as RemittanceExpenseType]} डुडुवा विप्रेषण`,
      ),
      "वडा अनुसार रेमिटेन्स खर्च",
      "विप्रेषण उपयोग तथ्याङ्क",
      "रेमिट्यान्स सर्वेक्षण डुडुवा",
      `डुडुवा विप्रेषण प्राप्त घरपरिवार संख्या ${totalHouseholds}`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality remittance expenses",
      "duduwa remittance utilization",
      `duduwa ${EXPENSE_NAMES_EN[topExpenses[0] as RemittanceExpenseType]} expenses`,
      ...topExpenses.map(
        (r) =>
          `${EXPENSE_NAMES_EN[r as RemittanceExpenseType]} expenses in duduwa`,
      ),
      "Ward-wise remittance expenses",
      "Remittance utilization statistics",
      "Remittance survey duduwa",
      `duduwa households receiving remittance ${totalHouseholds}`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `डुडुवा गाउँपालिकाको वडा अनुसार रेमिट्यान्स (विप्रेषण) खर्च वितरण, प्रवृत्ति र विश्लेषण। कुल विप्रेषण प्राप्त घरपरिवार संख्या ${totalHouseholds} मध्ये ${remittanceExpenseLabels[topExpenses[0] as RemittanceExpenseType]} (${expenseCounts[topExpenses[0]]}) सबैभन्दा ठूलो समूह हो, त्यसपछि ${remittanceExpenseLabels[topExpenses[1] as RemittanceExpenseType]} (${expenseCounts[topExpenses[1]]}) र ${remittanceExpenseLabels[topExpenses[2] as RemittanceExpenseType]} (${expenseCounts[topExpenses[2]]})। विभिन्न विप्रेषण खर्च प्रकारहरूको विस्तृत तथ्याङ्क र विजुअलाइजेसन।`;

    const descriptionEN = `Ward-wise remittance expense distribution, trends and analysis for duduwa Rural Municipality. Out of ${totalHouseholds} households receiving remittances, ${EXPENSE_NAMES_EN[topExpenses[0] as RemittanceExpenseType]} (${expenseCounts[topExpenses[0]]}) is the largest expense category, followed by ${EXPENSE_NAMES_EN[topExpenses[1] as RemittanceExpenseType]} (${expenseCounts[topExpenses[1]]}) and ${EXPENSE_NAMES_EN[topExpenses[2] as RemittanceExpenseType]} (${expenseCounts[topExpenses[2]]})। Detailed statistics and visualizations of various remittance expense patterns.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="रेमिट्यान्स खर्च - डुडुवा गाउँपालिका (Remittance Expenses - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा रेमिट्यान्स खर्च
            </h1>
            ...
            <p>
              डुडुवा गाउँपालिकामा विप्रेषण रकम प्राप्त गर्ने घरपरिवारहरूले
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा विप्रेषण रकमको खर्च निम्न क्षेत्रहरूमा
            ...
            <p>
              ...
              डुडुवा गाउँपालिकाको आफ्नै सर्वेक्षणबाट संकलन गरिएको हो। यी
