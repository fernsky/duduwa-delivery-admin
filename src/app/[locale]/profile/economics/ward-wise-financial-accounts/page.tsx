...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका वित्तीय पहुँच",
    ...
    const keywordsEN = [
      "duduwa Rural Municipality financial access",
    ...
    return {
      title: "वित्तीय खाताको वितरण | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="वित्तीय खाताको वितरण - डुडुवा गाउँपालिका (Distribution of Financial Accounts - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा वित्तीय खाताहरूको वितरण
            </h1>
            ...
            <p>
              ...
              यस खण्डमा डुडुवा गाउँपालिकाको विभिन्न वडाहरूमा नागरिकले
            ...
            <p>
              डुडुवा गाउँपालिकामा वित्तीय खाताको वितरण निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा वित्तीय खाताहरूको विश्लेषण गर्दा, समग्रमा
            ...
            <p>
              डुडुवा गाउँपालिकामा वित्तीय खाताहरूको वितरणको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी डुडुवा गाउँपालिकामा वित्तीय खाताहरूको वितरणको विश्लेषणले
