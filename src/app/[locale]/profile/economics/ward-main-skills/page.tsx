...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका सीप र दक्षता",
      "डुडुवा स्थानीय सीप",
      `डुडुवा ${skillLabels[topSkills[0]]} जनसंख्या`,
      ...topSkills.map((s) => `${skillLabels[s]} सीप डुडुवा`),
      "वडा अनुसार सीप वितरण",
      "आर्थिक दक्षता तथ्याङ्क",
      "सीप सर्वेक्षण डुडुवा",
      `डुडुवा कुल दक्ष जनसंख्या ${localizeNumber(totalPopulation.toString(), "ne")}`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality skills and abilities",
      "duduwa local skills",
      `duduwa ${SKILL_NAMES_EN[topSkills[0]]} population`,
      ...topSkills.map((s) => `${SKILL_NAMES_EN[s]} in duduwa`),
      "Ward-wise skills distribution",
      "Economic skills statistics",
      "Skills survey duduwa",
      `duduwa total skilled population ${totalPopulation}`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `डुडुवा गाउँपालिकाको वडा अनुसार प्रमुख सीप र दक्षताहरूको वितरण, प्रवृत्ति र विश्लेषण। कुल दक्ष जनसंख्या ${localizeNumber(totalPopulation.toString(), "ne")} मध्ये ${skillLabels[topSkills[0]]} (${localizeNumber(skillCounts[topSkills[0]].toString(), "ne")}) सबैभन्दा ठूलो समूह हो, त्यसपछि ${skillLabels[topSkills[1]]} (${localizeNumber(skillCounts[topSkills[1]].toString(), "ne")}) र ${skillLabels[topSkills[2]]} (${localizeNumber(skillCounts[topSkills[2]].toString(), "ne")})। विभिन्न सीपहरूको विस्तृत तथ्याङ्क र विजुअलाइजेसन।`;

    const descriptionEN = `Ward-wise major skills distribution, trends and analysis for duduwa Rural Municipality. Out of a total skilled population of ${totalPopulation}, ${SKILL_NAMES_EN[topSkills[0]]} (${skillCounts[topSkills[0]]}) is the largest group, followed by ${SKILL_NAMES_EN[topSkills[1]]} (${skillCounts[topSkills[1]]}) and ${SKILL_NAMES_EN[topSkills[2]]} (${skillCounts[topSkills[2]]})। Detailed statistics and visualizations of various skills.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="प्रमुख सीप र दक्षता - डुडुवा गाउँपालिका (Major Skills - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा प्रमुख सीप र दक्षता
            </h1>
            ...
            <p>
              डुडुवा गाउँपालिकामा विभिन्न प्रकारका सीप र दक्षता भएका
            ...
            <p>
              डुडुवा गाउँपालिकामा विभिन्न सीप र दक्षता भएका नागरिकहरूको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा विभिन्न किसिमका सीपहरू उपलब्ध छन्। यी
              सीपहरू मध्ये{" "}
              {skillLabels[
