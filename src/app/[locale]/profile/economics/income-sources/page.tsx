...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका आयस्रोत",
      "डुडुवा घरपरिवार आय",
      `डुडुवा ${INCOME_SOURCE_NAMES_NP[topIncomeSources[0]]} घरपरिवार`,
      ...topIncomeSources.map(
        (r) => `${INCOME_SOURCE_NAMES_NP[r]} आय डुडुवा`,
      ),
      "वडा अनुसार आयस्रोत",
      "आय विविधता तथ्याङ्क",
      "आर्थिक जनगणना डुडुवा",
      `डुडुवा कुल घरपरिवार ${totalHouseholds}`,
    ];
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा घरपरिवारको आयस्रोत
            </h1>
            ...
            <p>
              यस खण्डमा डुडुवा गाउँपालिकाको विभिन्न वडाहरूमा बसोबास गर्ने
            ...
            <p>
              डुडुवा गाउँपालिकामा विविध आयस्रोतमा निर्भर घरपरिवारहरू बसोबास
            ...
            <p>
              डुडुवा गाउँपालिकामा विभिन्न आयस्रोतमा निर्भर घरपरिवारहरूको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा निम्न आयस्रोतहरू प्रमुख रूपमा देखिएका
