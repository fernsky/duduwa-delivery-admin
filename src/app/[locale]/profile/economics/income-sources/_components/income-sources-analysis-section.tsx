    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          आयस्रोत विश्लेषण
          <span className="sr-only">Income Sources Analysis of duduwa</span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h4 className="font-medium mb-2">
              प्रमुख आयस्रोत
              <span className="sr-only">
                Main Income Source in duduwa Rural Municipality
              </span>
            </h4>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topSource
                  ? `${((topSource.households / totalHouseholds) * 100).toFixed(2)}% of total households in duduwa Rural Municipality`
                  : ""}
              </span>
            </p>
          </div>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Primary to Secondary Income Source Ratio in duduwa
              </span>
            </h4>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topSource && secondSource
                  ? `For every ${topTwoSourceRatio} ${topSource.incomeSource.toLowerCase()} dependent households, there is 1 ${secondSource.incomeSource.toLowerCase()} dependent household in duduwa Rural Municipality`
                  : ""}
              </span>
            </p>
          </div>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">
            Income Source Diversification Analysis of duduwa Rural Municipality
          </span>
        </h3>
        ...
        <div className="space-y-4 mt-3">
          <div className="bg-card p-3 rounded border">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              डुडुवा गाउँपालिकामा आयस्रोतको विविधिकरण अवस्था मध्यम छ
            </p>
          </div>
        ...
        <div className="bg-card p-3 rounded border mt-4">
          ...
          <p className="text-sm mt-2">
            डुडुवा गाउँपालिकामा घरपरिवारहरूको आयस्रोत विविधिकरणलाई थप
        ...
        <p className="mt-5">
          डुडुवा गाउँपालिकाको आयस्रोत विविधिकरण रणनीति सम्बन्धी थप
