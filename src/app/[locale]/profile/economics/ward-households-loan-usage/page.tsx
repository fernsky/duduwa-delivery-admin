...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका कर्जा उपयोग",
      "डुडुवा ऋण प्रयोजन",
      `डुडुवा ${loanUseLabels[topLoanUses[0]]} कर्जा`,
      ...topLoanUses.map(
        (r) => `${loanUseLabels[r]} उद्देश्यका लागि कर्जा डुडुवा`,
      ),
      "वडा अनुसार कर्जा उपयोग",
      "ऋण प्रयोजन तथ्याङ्क",
      "कर्जा प्रयोजन सर्वेक्षण डुडुवा",
      `डुडुवा कुल ऋणी घरपरिवार संख्या ${totalHouseholds}`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality loan usage",
      "duduwa credit purposes",
      `duduwa ${loanUseLabels[topLoanUses[0]]} loans`,
      ...topLoanUses.map((r) => `${loanUseLabels[r]} purpose loans in duduwa`),
      "Ward-wise loan usage",
      "Credit purpose statistics",
      "Loan utilization survey duduwa",
      `duduwa total households with loans ${totalHouseholds}`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `डुडुवा गाउँपालिकामा वडा अनुसार कर्जाको उपयोग प्रयोजन वितरण, प्रवृत्ति र विश्लेषण। कुल घरपरिवार संख्या ${totalHouseholds} मध्ये ${loanUseLabels[topLoanUses[0]]} (${loanUseCounts[topLoanUses[0]]}) सबैभन्दा ठूलो समूह हो, त्यसपछि ${loanUseLabels[topLoanUses[1]]} (${loanUseCounts[topLoanUses[1]]}) र ${loanUseLabels[topLoanUses[2]]} (${loanUseCounts[topLoanUses[2]]})। विभिन्न ऋण उपयोग प्रयोजनको विस्तृत तथ्याङ्क र विजुअलाइजेसन।`;

    const descriptionEN = `Ward-wise loan usage distribution, trends and analysis for duduwa Rural Municipality. Out of a total of ${totalHouseholds} households, ${loanUseLabels[topLoanUses[0]]} (${loanUseCounts[topLoanUses[0]]}) is the largest category, followed by ${loanUseLabels[topLoanUses[1]]} (${loanUseCounts[topLoanUses[1]]}) and ${loanUseLabels[topLoanUses[2]]} (${loanUseCounts[topLoanUses[2]]})। Detailed statistics and visualizations of various loan usage purposes.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="कर्जाको उपयोग प्रयोजन - डुडुवा गाउँपालिका (Loan Usage Purposes - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा कर्जाको उपयोग प्रयोजन
            </h1>
            ...
            <p>
              डुडुवा गाउँपालिकामा कुल {totalHouseholds.toLocaleString()}{" "}
            ...
            <p>
              डुडुवा गाउँपालिकामा विभिन्न प्रयोजनका लागि कर्जा लिएका
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा घरपरिवारहरूले विभिन्न प्रयोजनका लागि
            ...
            <p>
              माथि प्रस्तुत गरिएका तथ्याङ्कहरू डुडुवा गाउँपालिकाको घरधुरी
