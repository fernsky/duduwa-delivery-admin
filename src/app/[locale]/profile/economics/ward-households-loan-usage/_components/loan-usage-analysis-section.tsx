    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">Loan Purpose Analysis of duduwa</span>
        </h3>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        ...
        <p>
          कर्जाको प्रयोजन विश्लेषणबाट देखिन्छ कि डुडुवा गाउँपालिकामा{" "}
        ...
        <p className="mt-2">
          डुडुवा गाउँपालिकाको कर्जा प्रयोजन सम्बन्धी थप जानकारीको लागि,
          कृपया{" "}
