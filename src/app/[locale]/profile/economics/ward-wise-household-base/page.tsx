...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका घरको जग",
      "डुडुवा घरको जग वितरण",
      "वडा अनुसार घरको जग",
      "घरको जग विवरण",
      "ढलान पिल्लरसहितको घर",
      "माटोको जोडाइ भएको घरहरू",
      `डुडुवा घरको जग संख्या ${localizeNumber(totalHouseholds.toString(), "ne")}`,
    ];
    ...
    return {
      title: "घरको जगको वितरण | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा घरको जगको वितरण
            </h1>
            ...
            <p>
              ...
              न्यूनीकरणको स्थिति देखाउँछ। यस खण्डमा डुडुवा गाउँपालिकामा
              घरको जगका प्रमुख प्रकारहरू र तिनको वडागत वितरणको विश्लेषण प्रस्तुत
              गरिएको छ।
            </p>
            <p>
              डुडुवा गाउँपालिकामा घरको जगको तथ्याङ्क हेर्दा, कुल घरधुरी{" "}
            ...
            <p>
              डुडुवा गाउँपालिकामा घरको जगका प्रमुख प्रकारहरू र तिनको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा घरको जगको विश्लेषण गर्दा,
