...
export const metadata: Metadata = {
  title: "डुडुवा गाउँपालिका आर्थिक अवस्था | डिजिटल प्रोफाइल",
  description:
    "डुडुवा गाउँपालिकाको आर्थिक तथ्याङ्क: घरपरिवारको आय स्रोत, खेती, पशुपालन, रोजगारी, व्यावसायिक क्षेत्र, उत्पादन विवरण र आर्थिक विकास सम्बन्धी जानकारी।",
  keywords: [
    "डुडुवा गाउँपालिका",
    "आर्थिक अवस्था",
    "कृषि",
  ...
  openGraph: {
    ...
    type: "article",
    locale: "ne_NP",
    siteName: "डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
  },
};
...
const economicCategories = [
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उपलब्ध विशेष सीप भएका मानव संशाधनको वडागत विवरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा घरको स्वामित्व (आफ्नै, भाडा, संस्थागत आदि) अनुसार घरधुरी वितरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा घरको जग/फाउण्डेसनको प्रकार अनुसार घरधुरीको वितरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा घरको बाहिरी गारो (इट्टा, ढुङ्गा, माटो आदि) को प्रकार अनुसार घरधुरी विवरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकाबाट वैदेशिक रोजगारीमा गएका व्यक्तिहरूको देश अनुसार वितरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा वैदेशिक रोजगारीबाट प्राप्त हुने विप्रेषणको वडागत विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा जग्गाको स्वामित्व अनुसार घरधुरीहरूको वडागत वितरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा सिंचाई भएको र नभएको क्षेत्रको वडागत विवरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा विभिन्न सिंचाई स्रोत (नदी, कुलो, बोरिङ्ग आदि) अनुसार सिंचित जमिन।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उत्पादन हुने विभिन्न अन्नबालीहरूको विस्तृत उत्पादन विवरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उत्पादन हुने विभिन्न दलहनबालीहरूको विस्तृत विवरण र उत्पादन परिमाण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उत्पादन हुने विभिन्न तेलबालीहरूको तथ्याङ्क र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उत्पादन हुने विभिन्न फलफुल बालीहरूको विस्तृत उत्पादन विवरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उत्पादन हुने विभिन्न मसलाबालीहरूको विस्तृत उत्पादन तथ्याङ्क।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उत्पादन हुने विभिन्न तरकारीबालीहरूको विस्तृत तथ्याङ्क र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उत्पादन हुने विभिन्न पशुपन्छीजन्य वस्तुहरूको विवरण र परिमाण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा खाद्यान्न बालीमा लाग्ने प्रमुख रोगहरू र तिनको प्रभाव सम्बन्धी विवरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा तरकारी तथा फलफूलमा लाग्ने प्रमुख रोग र किराहरूको विस्तृत विवरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा रहेका व्यवसायिक कृषि तथा पशुपालन फर्महरूको विवरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा कृषि तथा पशुपालनमा संलग्न घरधुरीहरूको वडागत वितरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा सञ्चालित सहकारी संस्थाहरूको प्रकार, सदस्य संख्या र कार्यक्षेत्र सम्बन्धी विवरण।",
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="relative rounded-lg overflow-hidden">
          <Image
            ...
            alt="डुडुवा गाउँपालिका आर्थिक अवस्था"
            width={1200}
            height={400}
        ...
        <div className="mt-6 px-2">
          <h1 className="text-4xl font-bold mb-3">
            डुडुवा गाउँपालिकाको आर्थिक अवस्था
          </h1>
        </div>
        ...
        <section id="introduction">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              डुडुवा गाउँपालिकाको आर्थिक प्रोफाइलमा यहाँका नागरिकहरूको आय
            ...
            <p>
              यस खण्डमा प्रस्तुत गरिएका आर्थिक तथ्याङ्कहरूले डुडुवा
        ...
        <section id="economic-categories" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकाको आर्थिक अवस्था सम्बन्धी विस्तृत जानकारीका
        ...
        <section id="agriculture-livestock" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकाको प्रमुख आर्थिक क्षेत्र कृषि तथा पशुपालन
