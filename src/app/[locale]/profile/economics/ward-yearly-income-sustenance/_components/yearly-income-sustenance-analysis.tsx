    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">
            Income Sufficiency Status Analysis of duduwa
          </span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-card p-4 rounded border">
            ...
            <p className="mb-2">
              डुडुवा गाउँपालिकामा {yearRoundPercent}% घरपरिवार मात्र
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        <h3 className="text-xl font-medium mb-2">
          थप जानकारी
          <span className="sr-only">
            Additional Information about Income Sufficiency in duduwa
          </span>
        </h3>
        <p>
          डुडुवा गाउँपालिकाको वार्षिक आयको पर्याप्तता सम्बन्धी थप जानकारी
