...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका घरायसी कामकाज",
      "घरायसी कामकाजमा समय वितरण",
      `डुडुवा ${TIME_SPENT_NAMES_NP[topTimeCategories[0]]} घरायसी काम`,
      ...
      `डुडुवा जनसंख्या घरायसी काम ${totalPopulation}`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality household chores",
      "Household chores time distribution",
      `duduwa ${TIME_SPENT_NAMES_EN[topTimeCategories[0]]} household work`,
      ...topTimeCategories.map(
        (t) => `${TIME_SPENT_NAMES_EN[t]} spent on household chores in duduwa`,
      ),
      "Ward-wise household chores",
      "Time distribution for household work",
      "Household chores statistics",
      `duduwa population household work ${totalPopulation}`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `डुडुवा गाउँपालिकाको वडा अनुसार घरायसी कामकाजमा बिताइने समयको वितरण र विश्लेषण। कुल ${totalPopulation} जनसंख्या मध्ये ${TIME_SPENT_NAMES_NP[topTimeCategories[0]]} (${timeSpentCounts[topTimeCategories[0]]}) सबैभन्दा धेरै अपनाइएको समय अवधि हो, त्यसपछि ${TIME_SPENT_NAMES_NP[topTimeCategories[1]]} (${timeSpentCounts[topTimeCategories[1]]}) र ${TIME_SPENT_NAMES_NP[topTimeCategories[2]]} (${timeSpentCounts[topTimeCategories[2]]})। घरायसी कामकाजमा खर्चिने समय सम्बन्धी विस्तृत तथ्याङ्क र विश्लेषण।`;

    const descriptionEN = `Ward-wise time distribution and analysis of household chores in duduwa Rural Municipality. Out of total ${totalPopulation} population, ${TIME_SPENT_NAMES_EN[topTimeCategories[0]]} (${timeSpentCounts[topTimeCategories[0]]}) is the most common time spent, followed by ${TIME_SPENT_NAMES_EN[topTimeCategories[1]]} (${timeSpentCounts[topTimeCategories[1]]}) and ${TIME_SPENT_NAMES_EN[topTimeCategories[2]]} (${timeSpentCounts[topTimeCategories[2]]})। Detailed statistics and analysis on time spent on household chores.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरायसी कामकाज - डुडुवा गाउँपालिका (Household Chores - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा घरायसी कामकाजमा खर्चिने समय
            </h1>
            ...
            <p>
              घरायसी कामकाजमा खर्चिने समय अनुसार डुडुवा गाउँपालिकाको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा घरायसी कामकाजमा खर्चिने समयको विश्लेषण
