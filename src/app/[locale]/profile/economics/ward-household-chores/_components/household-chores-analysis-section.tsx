    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">Household Chores Analysis of duduwa</span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-card p-4 rounded border">
            <h4 className="font-medium mb-2">समय वितरण प्रवृत्ति</h4>
            <p className="text-sm mt-2">
              डुडुवा गाउँपालिकामा अधिकांश जनसंख्या ({mostCommonPercentage}
              %)
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        <h3 className="text-xl font-medium mb-2">
          ...
          <span className="sr-only">
            Overall Impact and Recommendations for duduwa
          </span>
        </h3>
        <p className="mb-3">
          डुडुवा गाउँपालिकामा घरायसी कामकाजको वितरण र त्यसको प्रभावहरू
          निम्नअनुसार छन्:
        </p>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        <h3 className="text-xl font-medium mb-2">
          थप जानकारी
          <span className="sr-only">
            Additional Information about Household Chores in duduwa
          </span>
        </h3>
        <p>
          डुडुवा गाउँपालिकाको घरायसी कामकाजमा खर्चिने समय सम्बन्धी थप
