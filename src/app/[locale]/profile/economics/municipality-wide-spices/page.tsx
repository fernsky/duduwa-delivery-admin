...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका मसलाबाली",
      "डुडुवा मसलाको उत्पादन",
      "पालिका स्तरीय मसलाबाली तथ्याङ्क",
      "लसुन उत्पादन डुडुवा",
      "खुर्सानी उत्पादन तथ्याङ्क",
      "धनिया उत्पादन",
      `डुडुवा मसलाबाली बिक्री ${localizeNumber(totalSales.toFixed(2), "ne")} टन`,
      `डुडुवा मसलाबाली आय ${localizeNumber(
    ...
    return {
      title:
        "मसलाबालीको प्रकार अनुसार उत्पादन र बिक्री | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा मसलाबालीको प्रकार अनुसार उत्पादन र बिक्री
            </h1>
            ...
            <p>
              मसलाबाली डुडुवा गाउँपालिकाको प्रमुख कृषि उत्पादनहरू मध्ये एक
            ...
            <p>
              डुडुवा गाउँपालिकाको मसलाबाली सम्बन्धी तथ्याङ्क अनुसार, यस
            ...
            <p>
              डुडुवा गाउँपालिकामा उत्पादित प्रमुख मसलाबालीहरू र तिनको
            ...
            <p>
              मसलाबालीको विश्लेषण गर्दा, डुडुवा गाउँपालिकामा उत्पादित कुल
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा मसलाबालीको उत्पादनले स्थानीय अर्थतन्त्रमा
            ...
            <p>
              डुडुवा गाउँपालिकाको प्रमुख मसलाबालीको उत्पादकत्व र बजारीकरणको
            ...
            <p>
              डुडुवा गाउँपालिकाको मसलाबालीको अवस्थाको विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              डुडुवा गाउँपालिकामा मसलाबालीको वर्तमान अवस्थाले अझै विकासको
