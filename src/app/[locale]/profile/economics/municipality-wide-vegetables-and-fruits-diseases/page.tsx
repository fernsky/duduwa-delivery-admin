...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका तरकारी फलफूल रोग कीट",
      "डुडुवा तरकारी उत्पादन समस्या",
      ...
      "आलु रोग कीट",
      "रायो रोग कीट",
      `डुडुवा तरकारी संरक्षण ${localizeNumber(totalVegetableFruits.toString(), "ne")} प्रकार`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality vegetables fruits diseases pests",
      "duduwa vegetable production problems",
      ...
      `duduwa vegetable protection ${totalVegetableFruits} types`,
    ];

    // Create description
    const descriptionNP = `डुडुवा गाउँपालिकाको तरकारी र फलफूलमा देखिने रोग र कीटको विश्लेषण। ${localizeNumber(totalVegetableFruits.toString(), "ne")} प्रकारका तरकारी फलफूलमा देखिने प्रमुख रोग र कीटहरूको विस्तृत अध्ययन। सबैभन्दा प्रभावित ${VEGETABLE_FRUIT_TYPES[mostAffectedVegetableFruit] || mostAffectedVegetableFruit} रहेको छ। पालिका स्तरीय तरकारी संरक्षण योजना र रणनीतिको विश्लेषण।`;

    const descriptionEN = `Analysis of diseases and pests affecting vegetables and fruits in duduwa Rural Municipality. Detailed study of major diseases and pests affecting ${totalVegetableFruits} types of vegetables and fruits. Most affected crop is ${VEGETABLE_FRUIT_TYPES_EN[mostAffectedVegetableFruit] || mostAffectedVegetableFruit}. Municipality-wide vegetable and fruit protection planning and strategy analysis.`;
    ...
    return {
      title:
        "तरकारी र फलफूलमा रोग कीटपतंग | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="तरकारी र फलफूलमा रोग कीटपतंग - डुडुवा गाउँपालिका (Vegetable and Fruit Diseases and Pests - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा तरकारी र फलफूलमा रोग र कीटपतंग
            </h1>
            ...
            <p>
              तरकारी र फलफूलमा देखिने रोग र कीटपतंग डुडुवा गाउँपालिकाको
            ...
            <p>
              डुडुवा गाउँपालिकाको तरकारी र फलफूलमा रोग र कीट सम्बन्धी
            ...
            <p>
              डुडुवा गाउँपालिकामा देखिने प्रमुख तरकारी र फलफूल रोगहरू
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा तरकारी र फलफूलमा रोग र कीटपतंगको
            ...
            <p>
              डुडुवा गाउँपालिकाको तरकारी र फलफूलमा रोग र कीटपतंगको अवस्थाको
