...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका घर स्वामित्व",
      "डुडुवा घर स्वामित्व वितरण",
      "वडा अनुसार घर स्वामित्व",
      "घर स्वामित्व विवरण",
      "निजी घर स्वामित्व डुडुवा",
      "भाडामा बस्नेको संख्या",
      `डुडुवा घर स्वामित्व संख्या ${localizeNumber(totalHouseholds.toString(), "ne")}`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality house ownership",
      "duduwa house ownership distribution",
      "Ward-wise house ownership",
      "House ownership details",
      "Private house ownership in duduwa",
      "Rented households count",
      `duduwa household ownership count ${totalHouseholds}`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `डुडुवा गाउँपालिकाको वडा अनुसार घर स्वामित्वको वितरण र विश्लेषण। कुल घरधुरी संख्या ${localizeNumber(totalHouseholds.toString(), "ne")} मध्ये ${localizeNumber(mostCommonPercentage, "ne")}% (${localizeNumber(mostCommonCount.toString(), "ne")}) ${OWNERSHIP_TYPE_NAMES[mostCommonType] || mostCommonType} स्वामित्वमा रहेका छन्। विभिन्न वडाहरूमा घर स्वामित्वको विस्तृत विश्लेषण।`;

    const descriptionEN = `Ward-wise distribution and analysis of house ownership in duduwa Rural Municipality. Out of a total of ${totalHouseholds} households, ${mostCommonPercentage}% (${mostCommonCount}) are under ${OWNERSHIP_TYPE_NAMES_EN[mostCommonType] || mostCommonType}. Detailed analysis of house ownership across various wards.`;
    ...
    return {
      title: "घर स्वामित्वको वितरण | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घर स्वामित्वको वितरण - डुडुवा गाउँपालिका (House Ownership Distribution - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा घर स्वामित्वको वितरण
            </h1>
            ...
            <p>
              ...
              आर्थिक तथा सामाजिक सूचकहरू प्राप्त हुन्छन्। यस खण्डमा डुडुवा
              गाउँपालिकामा घर स्वामित्वका प्रमुख प्रकारहरू र तिनको वडागत वितरणको
              विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              डुडुवा गाउँपालिकामा घर स्वामित्वको तथ्याङ्क हेर्दा, कुल
            ...
            <p>
              डुडुवा गाउँपालिकामा घर स्वामित्वका प्रमुख प्रकारहरू र तिनको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा घर स्वामित्वको विश्लेषण गर्दा,
