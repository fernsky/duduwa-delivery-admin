...
export default function FarmersGroupAnalysisSection({
  ...
  return (
    <>
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        <h3 className="text-xl font-medium mb-6">
          ...
          <span className="sr-only">
            Detailed Agricultural and Animal Husbandry Analysis of duduwa
          </span>
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            <h4 className="font-medium mb-2">
              प्रमुख व्यवसाय
              <span className="sr-only">
                Main Business in duduwa Rural Municipality
              </span>
            </h4>
            {primaryBusiness && (
        ...
        <div className="mt-6 pt-4 border-t">
          ...
          <p className="text-sm">
            डुडुवा गाउँपालिकामा सञ्चालित व्यावसायिक कृषि तथा पशुपालन
      ...
      <p className="mt-4">
        डुडुवा गाउँपालिकाका व्यावसायिक कृषि तथा पशुपालन समूहहरूले विभिन्न
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        <div className="border rounded-lg p-6 bg-muted/30">
          ...
          <p className="text-muted-foreground text-sm mb-4">
            डुडुवामा सबैभन्दा लोकप्रिय व्यावसायिक समूह, जुन कुल समूहको
            {localizeNumber(
