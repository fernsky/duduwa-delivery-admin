...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "सिंचाई स्रोतको प्रकार अनुसार क्षेत्रफल | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="सिंचाई स्रोतको प्रकार अनुसार क्षेत्रफल - डुडुवा गाउँपालिका (Irrigation Sources by Coverage Area - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा सिंचाई स्रोतको प्रकार अनुसार क्षेत्रफल
            </h1>
            ...
            <p>
              ...
              डुडुवा गाउँपालिकामा कृषि क्षेत्रलाई अझ उत्पादनशील बनाउनका
            ...
            <p>
              डुडुवा गाउँपालिकाको सिंचाई स्रोत सम्बन्धी तथ्याङ्क अनुसार,
            ...
            <p>
              डुडुवा गाउँपालिकामा सिंचाई स्रोतका प्रमुख प्रकारहरू र तिनको
            ...
            <p>
              सिंचाई स्रोतको विश्लेषण गर्दा, डुडुवा गाउँपालिकामा परम्परागत
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा सिंचाई स्रोतको प्रकारले सिंचाई व्यवस्थापन
            ...
            <p>
              डुडुवा गाउँपालिकाको सिंचाई स्रोतको अवस्थाको विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              डुडुवा गाउँपालिकामा सिंचाई स्रोतको वर्तमान अवस्थाले सिंचाई
