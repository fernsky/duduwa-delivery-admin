...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "डुडुवा गाउँपालिकाको तापक्रम विश्लेषण र जलवायु परिवर्तन प्रभाव",
    keywords: [
      "डुडुवा गाउँपालिका तापक्रम विश्लेषण",
      "जलवायु परिवर्तन डुडुवा",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="तापक्रम विश्लेषण - डुडुवा गाउँपालिका"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकाको तापक्रम विश्लेषण
            </h1>
            <p>
