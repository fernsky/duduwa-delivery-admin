...
export const metadata: Metadata = {
  title: "डुडुवा गाउँपालिका खानेपानी तथा सरसफाइ | डिजिटल प्रोफाइल",
  description:
    "डुडुवा गाउँपालिकाको खानेपानी तथा सरसफाइ सम्बन्धी तथ्याङ्क: खानेपानीको श्रोत, पानी शुद्धीकरण, शौचालयको प्रकार र फोहोरमैला व्यवस्थापन सम्बन्धी विस्तृत विवरण।",
  keywords: [
    "डुडुवा गाउँपालिका",
    "खानेपानी",
    "सरसफाइ",
...
const waterSanitationCategories = [
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उपलब्ध खानेपानीको श्रोतहरू र ती श्रोतहरूको प्रयोग गर्ने घरधुरीहरूको वडागत विवरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा घरपरिवारले खानेपानी शुद्धीकरण गर्न अपनाउने विधिहरू र तिनको वितरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा प्रयोग हुने विभिन्न प्रकारका शौचालयहरू र तिनको प्रयोग गर्ने घरपरिवारको वितरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा फोहोरमैला व्यवस्थापनका विधिहरू र तिनको प्रयोग गर्ने घरधुरीहरूको वडागत विश्लेषण।",
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="relative rounded-lg overflow-hidden">
          <Image
            ...
            alt="डुडुवा गाउँपालिका खानेपानी तथा सरसफाइ"
            width={1200}
            height={400}
        ...
        <div className="mt-6 px-2">
          <h1 className="text-4xl font-bold mb-3">
            डुडुवा गाउँपालिकाको खानेपानी तथा सरसफाइ
          </h1>
        </div>
        ...
        <section id="introduction">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              ...
              जीवनस्तरको महत्त्वपूर्ण सूचकहरू हुन्। डुडुवा गाउँपालिकाको
        ...
        <section id="water-sanitation-categories" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकाको खानेपानी तथा सरसफाइ सम्बन्धी विस्तृत
        ...
        <section id="improvement-strategies" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकामा खानेपानी तथा सरसफाइको अवस्था सुधार गर्न
