...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका शौचालय प्रकार",
      "वडागत शौचालय प्रकारहरू",
      "फ्लस शौचालय भएका घरधुरी",
      "सार्वजनिक शौचालय प्रयोग",
      "शौचालय नभएका घरधुरी",
      `डुडुवा शौचालय तथ्याङ्क ${localizeNumber(
    ...
    const keywordsEN = [
      "duduwa Rural Municipality toilet types",
      "Ward-wise toilet facilities",
      "Flush toilet with septic tank households",
      "Public toilet usage",
      "Households without toilet",
      `duduwa toilet facilities data ${totalHouseholds}`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `डुडुवा गाउँपालिकामा वडा अनुसार शौचालय प्रकारहरूको वितरण र विश्लेषण। कुल घरधुरी संख्या ${localizeNumber(
      totalHouseholds.toString(),
      "ne",
    ...
    const descriptionEN = `Ward-wise distribution and analysis of toilet types in duduwa Rural Municipality. Out of a total of ${totalHouseholds} households, ${mostCommonPercentage}% (${mostCommonCount}) use ${mostCommonTypeName}. Detailed analysis of toilet types across various wards.`;
    ...
    return {
      title: "शौचालय प्रकारहरू | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="शौचालय प्रकारहरू - डुडुवा गाउँपालिका (Toilet Types - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा शौचालय प्रकारहरूको अवस्था
            </h1>
            ...
            <p>
              ...
              मद्दत गर्दछ। यस खण्डमा डुडुवा गाउँपालिकाका विभिन्न वडाहरूमा
            ...
            <p>
              डुडुवा गाउँपालिकामा शौचालयका प्रमुख प्रकारहरू र तिनको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा शौचालय प्रकारहरूको विश्लेषण गर्दा,
            ...
            <p>
              डुडुवा गाउँपालिकामा शौचालय सुविधाहरू सुधार गर्न निम्न
            ...
            <p className="mt-6">
              यी सिफारिसहरू कार्यान्वयन गरेर, डुडुवा गाउँपालिकामा शौचालय
