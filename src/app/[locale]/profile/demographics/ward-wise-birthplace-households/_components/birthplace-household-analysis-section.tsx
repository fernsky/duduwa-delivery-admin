            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {overallSummary.find(
                  ...
                  ? `डुडुवा गाउँपालिकामा ${localizeNumber((((overallSummary.find((item) => item.birthPlace === "SAME_MUNICIPALITY")?.households || 0) / totalHouseholds) * 100).toFixed(2), "ne")}% घरपरिवारहरूको जन्मस्थान यहि गाउँपालिकामा रहेको छ।`
