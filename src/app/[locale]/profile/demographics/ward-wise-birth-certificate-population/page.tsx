...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      ...
      `डुडुवा जन्मदर्ताको स्थिति: जन्मदर्ता भएका ${localizeNumber(totalWithCertificate.toString(), "ne")}, नभएका ${localizeNumber(totalWithoutCertificate.toString(), "ne")}`,
      `डुडुवा पाँच वर्षमुनिका कुल बालबालिका संख्या ${localizeNumber(totalPopulation.toString(), "ne")}`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality birth registration",
      "Children under five birth certificate",
      "Ward-wise birth registration data",
      "Birth certificate analysis",
      "Birth certificate holders in duduwa",
      `duduwa birth registration status: with certificate ${totalWithCertificate}, without certificate ${totalWithoutCertificate}`,
      `duduwa total children under five years: ${totalPopulation}`,
    ];

    // Create detailed description with actual data
    const descriptionNP = `डुडुवा गाउँपालिकाको वडा अनुसार पाँच वर्षमुनिका बालबालिकाहरूको जन्मदर्ता प्रमाणपत्र वितरण र विश्लेषण। कुल ${localizeNumber(totalPopulation.toString(), "ne")} बालबालिकामध्ये ${localizeNumber(totalWithCertificate.toString(), "ne")} जनासँग जन्मदर्ता प्रमाणपत्र छ भने ${localizeNumber(totalWithoutCertificate.toString(), "ne")} जनासँग छैन।`;

    const descriptionEN = `Ward-wise distribution and analysis of birth certificate holders among children under five in duduwa Rural Municipality. Out of ${totalPopulation} total children, ${totalWithCertificate} have birth certificates and ${totalWithoutCertificate} do not have birth certificates.`;
    ...
    return {
      title:
        "पाँच वर्षमुनिका बालबालिका जन्मदर्ता | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="पाँच वर्षमुनिका बालबालिका जन्मदर्ता - डुडुवा गाउँपालिका (Birth Certificates for Children Under Five - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा पाँच वर्षमुनिका बालबालिकाहरूको जन्मदर्ता
            </h1>
            ...
            <p>
              ...
              पहुँच सुनिश्चित गर्दछ। यस खण्डमा डुडुवा गाउँपालिकामा रहेका
              पाँच वर्षमुनिका बालबालिकाहरूको जन्मदर्ता स्थिति प्रस्तुत गरिएको छ।
            </p>
            <p>
              डुडुवा गाउँपालिकाभरि पाँच वर्षमुनिका बालबालिकाहरूको कुल
              संख्या
            ...
            <p>
              डुडुवा गाउँपालिकामा पाँच वर्षमुनिका बालबालिकाको जन्मदर्ता
