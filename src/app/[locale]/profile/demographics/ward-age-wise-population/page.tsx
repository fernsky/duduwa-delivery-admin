...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका उमेर जनसंख्या",
      "डुडुवा उमेरगत विविधता",
      `डुडुवा बाल जनसंख्या ${localizeNumber(childrenPct, "ne")}%`,
      `डुडुवा युवा जनसंख्या ${localizeNumber(youthPct, "ne")}%`,
    ...
    const keywordsEN = [
      "duduwa Rural Municipality age distribution",
      "duduwa age demographics",
      `duduwa children population ${childrenPct}%`,
      `duduwa youth population ${youthPct}%`,
    ...
    const descriptionNP = `डुडुवा गाउँपालिकाको वडा अनुसार उमेर समूहको जनसंख्या वितरण, प्रवृत्ति र विश्लेषण। कुल जनसंख्या ${localizeNumber(totalPopulation.toString(), "ne")} मध्ये बाल जनसंख्या ${localizeNumber(childrenPct, "ne")}%, युवा जनसंख्या ${localizeNumber(youthPct, "ne")}% रहेको छ। उमेर समूह अनुसार विस्तृत तथ्याङ्क र विजुअलाइजेसन।`;

    const descriptionEN = `Ward-wise age group population distribution, trends and analysis for duduwa Rural Municipality. Out of a total population of ${totalPopulation}, children make up ${childrenPct}% and youth make up ${youthPct}%. Detailed statistics and visualizations of various age groups.`;

    return {
      title: `उमेर अनुसार जनसंख्या | डुडुवा गाउँपालिका | डिजिटल प्रोफाइल`,
      ...
      openGraph: {
        title: `उमेर अनुसार जनसंख्या | डुडुवा गाउँपालिका`,
        description: descriptionNP,
        type: "article",
        locale: "ne_NP",
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा उमेर अनुसार जनसंख्या
            </h1>
            ...
            <p>
              यो तथ्याङ्कले डुडुवा गाउँपालिकाको जनसांख्यिकीय लाभांश,
            ...
            <p>
              डुडुवा गाउँपालिकामा विभिन्न उमेर समूहका व्यक्तिहरूको वितरण
              निम्नानुसार छ:
            </p>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकाको जनसंख्याको उमेर संरचनाले निम्न
