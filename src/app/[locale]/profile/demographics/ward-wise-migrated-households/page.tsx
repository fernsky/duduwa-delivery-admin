...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका आप्रवासित घरपरिवार",
      "डुडुवा बसाइँसराइ परिवार वितरण",
      "वडा अनुसार आप्रवासित परिवार विवरण",
      "घरपरिवारको आप्रवासन विश्लेषण",
      "स्थानांतरित परिवार डुडुवा",
      "जिल्लान्तर आप्रवासन",
      `डुडुवा आप्रवासित घरपरिवार संख्या ${localizeNumber(totalHouseholds.toString(), "ne")}`,
    ];
    ...
    return {
      title: "आप्रवासित घरपरिवार | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा आप्रवासित घरपरिवार
            </h1>
            ...
            <p>
              ...
              गतिशीलताको विश्लेषण गर्न सहयोग गर्दछ। यस खण्डमा डुडुवा
              गाउँपालिकामा रहेका आप्रवासित घरपरिवारको स्थान अनुसारको वितरण र
              वडागत विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              डुडुवा गाउँपालिकामा रहेका आप्रवासित परिवारहरूको स्थानको
            ...
            <p>
              डुडुवा गाउँपालिकामा रहेका आप्रवासित परिवारहरूको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा रहेका आप्रवासित परिवारहरूको विश्लेषण
              गर्दा,
