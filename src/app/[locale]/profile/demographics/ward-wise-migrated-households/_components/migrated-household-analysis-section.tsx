    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">
            Migrated Household Analysis of duduwa
          </span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Most Common Migration Origin in duduwa Rural Municipality
              </span>
            </h4>
          ...
          >
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Inter-district Migrated Households in duduwa
              </span>
            </h4>
            <p className="text-3xl font-bold">
              {localizeNumber(
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {overallSummary.find(
                  ...
                  ? `डुडुवा गाउँपालिकामा ${localizeNumber((((overallSummary.find((item) => item.migratedFrom === "ANOTHER_DISTRICT")?.households || 0) / totalHouseholds) * 100).toFixed(2), "ne")}% आप्रवासित घरपरिवारहरू अन्य जिल्लाबाट आएका छन्।`
