...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका आर्थिक रूपमा सक्रिय जनसंख्या",
      "डुडुवा उमेर अनुसार जनसंख्या वितरण",
      "वडा अनुसार आर्थिक रूपमा सक्रिय जनसंख्या",
      "आर्थिक सक्रिय उमेर समूह विवरण",
      "१५-५९ वर्षका आर्थिक सक्रिय जनसंख्या",
      "वृद्ध जनसंख्या डुडुवा",
      "बाल जनसंख्या डुडुवा",
      `डुडुवा कुल जनसंख्या ${localizeNumber(totalPopulation.toString(), "ne")}`,
    ];

    const keywordsEN = [
      "duduwa Rural Municipality economically active population",
      "duduwa age-wise population distribution",
    ...
    return {
      title:
        "आर्थिक रूपमा सक्रिय जनसंख्या | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="आर्थिक रूपमा सक्रिय जनसंख्या - डुडुवा गाउँपालिका (Economically Active Population - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा आर्थिक रूपमा सक्रिय जनसंख्या
            </h1>
            ...
            <p>
              ...
              डुडुवा गाउँपालिकामा विभिन्न उमेर समूहका आर्थिक रूपमा सक्रिय
              जनसंख्याको वडागत वितरण र विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              डुडुवा गाउँपालिकामा उमेर समूह अनुसार आर्थिक सक्रिय जनसंख्याको
            ...
            <p>
              डुडुवा गाउँपालिकामा उमेर समूह अनुसार जनसंख्याको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा आर्थिक रूपमा सक्रिय जनसंख्या (१५-५९ वर्ष)
              समग्र जनसंख्याको
              {localizeNumber(
                (
                  ((overallSummary.find(
