...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका अपाङ्गताको कारण",
      "डुडुवा अपाङ्गता वितरण",
      "वडा अनुसार अपाङ्गताको कारण",
      "अपाङ्गताको कारण विवरण",
      "जन्मजात अपाङ्गता डुडुवा",
      "दुर्घटनाको कारण अपाङ्गता",
      `डुडुवा अपाङ्गता जनसंख्या ${localizeNumber(totalPopulationWithDisability.toString(), "ne")}`,
    ];
    ...
    return {
      title: "अपाङ्गताको कारणहरू | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा अपाङ्गताका कारणहरू
            </h1>
            ...
            <p>
              ...
              महत्त्वपूर्ण छ। यस खण्डमा डुडुवा गाउँपालिकामा अपाङ्गताका
              प्रमुख कारणहरू र तिनको वडागत वितरणको विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              डुडुवा गाउँपालिकामा अपाङ्गताका कारणहरूको तथ्याङ्क हेर्दा, कुल
              अपाङ्गता भएका{" "}
              {localizeNumber(
            ...
            <p>
              डुडुवा गाउँपालिकामा अपाङ्गताका प्रमुख कारणहरू र तिनको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा अपाङ्गताका कारणहरूको विश्लेषण गर्दा,
              {DISABILITY_CAUSE_NAMES[
