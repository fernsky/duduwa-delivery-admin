...
export default function WardWiseSEO({
  ...
  const generateStructuredData = () => {
    ...
    const wardObservations = processedWardData.map((ward) => ({
      "@type": "Observation",
      name: `डुडुवा गाउँपालिका वडा ${ward.wardNumber} demographics`,
      ...
      description: `डुडुवा गाउँपालिका वडा ${localizeNumber(
        ward.wardNumber,
        "ne",
    ...
    return {
      ...
      "@type": "Dataset",
      name: "डुडुवा गाउँपालिका - वडागत जनसांख्यिकी तथ्याङ्क",
      description: `डुडुवा गाउँपालिकाको ${localizeNumber(
      ...
      keywords: [
        ...
        "डुडुवा वडा जनसंख्या",
        "नेपाल जनगणना",
        "डुडुवा जनसंख्या वितरण",
        "डुडुवा लैङ्गिक अनुपात",
