...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका वडागत जनसंख्या",
      "डुडुवा गाउँपालिका वडा विवरण",
      "डुडुवा गाउँपालिका जनसांख्यिकी तथ्याङ्क",
      "डुडुवा गाउँपालिका घरधुरी विवरण",
      `डुडुवा गाउँपालिका जनसंख्या ${localizeNumber(totalPopulation, "ne")}`,
      `डुडुवा गाउँपालिका घरधुरी ${localizeNumber(totalHouseholds, "ne")}`,
      "डुडुवा गाउँपालिका लैङ्गिक अनुपात",
      "डुडुवा गाउँपालिका वडागत विश्लेषण",
      `डुडुवा गाउँपालिका वडा ${localizeNumber(highestWardNumber, "ne")} जनसंख्या ${localizeNumber(highestPopulation, "ne")}`,
      `डुडुवा पुरुष जनसंख्या ${localizeNumber(malePopulation, "ne")}`,
      `डुडुवा महिला जनसंख्या ${localizeNumber(femalePopulation, "ne")}`,
      `डुडुवा औसत परिवार संख्या ${localizeNumber(averageHouseholdSize, "ne")}`,
    ];
    ...
    return {
      ...
      openGraph: {
        title: `डुडुवा गाउँपालिका | वडागत जनसांख्यिकी सारांश`,
        description: descriptionNP,
        type: "article",
        locale: "ne_NP",
    ...
    return {
      title:
        "डुडुवा गाउँपालिका | वडागत जनसांख्यिकी सारांश | डिजिटल प्रोफाइल",
      description:
        "डुडुवा गाउँपालिकाको प्रत्येक वडाको जनसांख्यिकी विवरण, लिङ्ग अनुपात, घरधुरी र जनसंख्या वितरणको विश्लेषण।",
    };
  }
}
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिका | वडागत जनसांख्यिकी सारांश
            </h1>
            ...
            <p>
              यस खण्डमा डुडुवा गाउँपालिकाको प्रत्येक वडाको जनसांख्यिकी
            ...
            <p>
              वडागत विश्लेषणले डुडुवा गाउँपालिकाभित्र रहेका विविधता र
            ...
            >
              डुडुवा गाउँपालिकाको वडागत जनसंख्या वितरण
            </h2>
            <p>
              डुडुवा गाउँपालिकाको कुल जनसंख्या{" "}
              {localizeNumber(
              ...
              अन्य लिङ्गका व्यक्तिहरू रहेका छन्। डुडुवा गाउँपालिकाका
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकाको प्रत्येक वडाको जनसांख्यिकीय संरचनाको
