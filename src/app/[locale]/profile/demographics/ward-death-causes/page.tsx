...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका मृत्युका कारणहरू",
      "डुडुवा मृत्युदर विश्लेषण",
      `डुडुवा ${deathCauseLabels[topDeathCauses[0] as DeathCauseType]} मृत्यु संख्या`,
      ...topDeathCauses.map(
        (r) =>
          `${deathCauseLabels[r as DeathCauseType]} मृत्युको कारण डुडुवा`,
      ),
      "वडा अनुसार मृत्युका कारणहरू",
      "स्वास्थ्य तथ्याङ्क डुडुवा",
      "मृत्यु कारण सर्वेक्षण डुडुवा",
      `डुडुवा कुल मृत्यु संख्या ${localizeNumber(totalDeaths.toString(), "ne")}`,
    ];
    ...
    return {
      title: "मृत्युका प्रमुख कारणहरू | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा मृत्युका प्रमुख कारणहरू
            </h1>
            ...
            <p>
              यस खण्डमा डुडुवा गाउँपालिकाको विभिन्न वडाहरूमा मृत्युका
            ...
            <p>
              डुडुवा गाउँपालिकामा विभिन्न प्रकारका कारणहरूले मृत्यु हुने
            ...
            <p>
              डुडुवा गाउँपालिकामा विभिन्न कारणहरूले हुने मृत्युको संख्या
              निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा निम्न मृत्युका कारणहरू प्रमुख रूपमा
