...
export const metadata: Metadata = {
  title: "डुडुवा गाउँपालिका जनसांख्यिकी तथ्याङ्क | डिजिटल प्रोफाइल",
  description:
    "डुडुवा गाउँपालिकाको जनसांख्यिकी तथ्याङ्क: जनसंख्या, उमेर, लिङ्ग, जात, धर्म, मातृभाषा र वैवाहिक स्थिति सम्बन्धी विस्तृत तथ्याङ्क र विश्लेषण।",
  keywords: [
    "डुडुवा गाउँपालिका",
    "जनसांख्यिकी",
    "जनगणना",
...
const demographicCategories = [
  {
    ...
    description:
      "डुडुवा गाउँपालिकाको समग्र जनसंख्या, लिङ्ग अनुपात र घरधुरी सम्बन्धी सारांश तथ्याङ्क।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उमेर समूह अनुसार जनसंख्या वितरण र वडागत विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा बोलिने विभिन्न मातृभाषाहरू र तिनका वक्ताहरूको जनसंख्या।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा मानिने विभिन्न धर्महरू र तिनका अनुयायीहरूको जनसंख्या।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा विभिन्न जात र जनजातिको जनसंख्या र वितरण सम्बन्धी विस्तृत जानकारी।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा वडागत घरमूली लिङ्ग वितरण र लैङ्गिक समानताको अवस्था।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उमेर अनुसार वैवाहिक स्थिति सम्बन्धी तथ्याङ्क र विवाह दर।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उमेर समूह अनुसार आर्थिक रुपले सक्रिय जनसंख्याको विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा अपाङ्गताको कारण अनुसार जनसंख्याको वितरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा घरपरिवारको जन्मस्थान अनुसार वितरण र बसाई सराईको प्रवृत्ति।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा पाँच वर्षमुनिका बालबालिकाहरूको जन्मदर्ता सम्बन्धी तथ्याङ्क।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा उमेर तथा लिङ्ग अनुसार मृत्यु विवरण र मृत्युदर विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा मृत्युका विभिन्न कारणहरूको वितरण र विश्लेषण।",
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="relative rounded-lg overflow-hidden">
          <Image
            ...
            alt="डुडुवा गाउँपालिका जनसांख्यिकी"
            width={1200}
            height={400}
        ...
        <div className="mt-6 px-2">
          <h1 className="text-4xl font-bold mb-3">
            डुडुवा गाउँपालिकाको जनसांख्यिक विवरण
          </h1>
        </div>
        ...
        <section id="introduction">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              ...
              अत्यन्त महत्त्वपूर्ण हुन्छ। डुडुवा गाउँपालिकाको जनसांख्यिकी
        ...
        <section id="demographic-categories" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकाको जनसांख्यिकी सम्बन्धी विस्तृत जानकारीका
        ...
        <section id="population-distribution" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकाको विस्तृत जनसंख्या वितरण, वडागत विश्लेषण,
