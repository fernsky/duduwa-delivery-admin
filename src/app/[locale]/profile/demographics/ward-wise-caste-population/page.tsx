...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका जातिगत जनसंख्या",
      "डुडुवा जातिगत विविधता",
      `डुडुवा ${CASTE_NAMES_NP[topCastes[0]]} जनसंख्या`,
      ...topCastes.map((c) => `${CASTE_NAMES_NP[c]} जातिगत विवरण डुडुवा`),
      "वडा अनुसार जातिगत जनसंख्या",
      "जातिगत विविधता तथ्याङ्क",
      "जातिगत जनगणना डुडुवा",
    ...
    return {
      ...
      openGraph: {
        title: `डुडुवा गाउँपालिका | जाति अनुसार जनसंख्या`,
        description: descriptionNP,
        type: "article",
        locale: "ne_NP",
    ...
    return {
      title: "डुडुवा गाउँपालिका | जाति अनुसार जनसंख्या | डिजिटल प्रोफाइल",
      description:
        "डुडुवा गाउँपालिकाको प्रत्येक वडाको जातिगत विवरण, जातिहरूको संख्या र जातिगत विविधताको विश्लेषण।",
    };
  }
}
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              <span className="font-bold">डुडुवा गाउँपालिका</span> | जाति
            ...
            <p>
              यस खण्डमा <strong>डुडुवा गाउँपालिका</strong>को विभिन्न
            ...
            <p>
              ...
              <strong>डुडुवा गाउँपालिका</strong>मा पनि विभिन्न जातजातिहरूको
            ...
            <p>
              <strong>डुडुवा गाउँपालिका</strong>मा विभिन्न जातिहरूको कुल
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              <strong>डुडुवा गाउँपालिका</strong>मा निम्न जातिहरू प्रमुख
