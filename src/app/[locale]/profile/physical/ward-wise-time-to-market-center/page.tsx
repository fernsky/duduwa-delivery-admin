...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका बजार केन्द्र पहुँच",
    ...
    const keywordsEN = [
      "duduwa Rural Municipality market center access",
    ...
    // Create description
    const descriptionNP = `डुडुवा गाउँपालिकामा बजार केन्द्रसम्म पुग्ने समय सम्बन्धी विश्लेषण। कुल ${localizeNumber(totalHouseholds.toLocaleString(), "ne")} घरधुरी मध्ये ${localizeNumber(under15MinPercentage, "ne")}% (${localizeNumber(under15MinHouseholds.toLocaleString(), "ne")}) घरधुरीले १५ मिनेटभित्र बजार केन्द्र पुग्न सक्छन्।`;

    const descriptionEN = `Analysis of time taken to reach market centers in duduwa Rural Municipality. Out of a total of ${totalHouseholds.toLocaleString()} households, ${under15MinPercentage}% (${under15MinHouseholds.toLocaleString()}) can reach a market center within 15 minutes.`;
    ...
    return {
      title:
        "बजार केन्द्र पुग्न लाग्ने समयको अवस्था | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="बजार केन्द्र पुग्न लाग्ने समय - डुडुवा गाउँपालिका (Time to Market Center - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको अवस्था
            </h1>
            ...
            <p>
              ...
              पुर्‍याउँछ। यस खण्डमा डुडुवा गाउँपालिकाको विभिन्न वडाहरूमा
            ...
            <p>
              डुडुवा गाउँपालिकामा बजार केन्द्रसम्म पुग्न लाग्ने समयको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा बजार केन्द्र पहुँचको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(
                timeCategoryPercentages.UNDER_30_MIN.toFixed(2),
                "ne",
            ...
            <p>
              डुडुवा गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी डुडुवा गाउँपालिकामा बजार केन्द्र पुग्न लाग्ने समयको
