...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका घरायसी सुविधा",
    ...
    const keywordsEN = [
      "duduwa Rural Municipality household facilities",
    ...
    // Create description
    const descriptionNP = `डुडुवा गाउँपालिकामा घरायसी सुविधाको प्रयोगको विश्लेषण। ${localizeNumber(mobilePercentage, "ne")}% घरहरूमा मोबाइल फोन, ${localizeNumber(televisionPercentage, "ne")}% घरहरूमा टेलिभिजन र ${localizeNumber(internetPercentage, "ne")}% घरहरूमा इन्टरनेट सुविधा रहेको छ।`;

    const descriptionEN = `Analysis of household facilities usage in duduwa Rural Municipality. ${mobilePercentage}% of households have mobile phones, ${televisionPercentage}% have television and ${internetPercentage}% have internet access.`;
    ...
    return {
      title:
        "घरायसी सुविधाको प्रयोगको अवस्था | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरायसी सुविधाको प्रयोगको अवस्था - डुडुवा गाउँपालिका (Household Facilities Usage - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा घरायसी सुविधाको प्रयोगको अवस्था
            </h1>
            ...
            <p>
              ...
              पार्दछ। यस खण्डमा डुडुवा गाउँपालिकाको विभिन्न वडाहरूमा प्रयोग
              हुने घरायसी सुविधाहरूको विस्तृत विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              डुडुवा गाउँपालिकामा अनुमानित कुल{" "}
              {localizeNumber(
            ...
            <p>
              डुडुवा गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको विश्लेषण
            ...
            <p>
              डुडुवा गाउँपालिकामा घरायसी सुविधाको प्रयोगको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी डुडुवा गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको
