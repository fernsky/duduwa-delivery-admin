...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका प्रसूती स्थान",
      "संस्थागत प्रसूती",
    ...
    const keywordsEN = [
      "duduwa Rural Municipality childbirth places",
    ...
    return {
      title: "प्रसूती स्थानको अवस्था | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="प्रसूती स्थानको अवस्था - डुडुवा गाउँपालिका (Delivery Place Statistics - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा प्रसूती स्थानको अवस्था
            </h1>
            ...
            <p>
              ...
              गर्न मद्दत गर्दछ। यस खण्डमा डुडुवा गाउँपालिकाको विभिन्न
            ...
            <p>
              डुडुवा गाउँपालिकामा प्रसूती स्थान सम्बन्धी महत्वपूर्ण
              तथ्यहरू:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा प्रसूती स्थानको वितरण निम्नानुसार रहेको
              छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा प्रसूती स्थानको विश्लेषण गर्दा, समग्रमा
              {localizeNumber(
                (
                  deliveryCategoryPercentages.GOVERNMENTAL_HEALTH_INSTITUTION +
                  deliveryCategoryPercentages.PRIVATE_HEALTH_INSTITUTION
            ...
            <p>
              डुडुवा गाउँपालिकामा संस्थागत प्रसूती प्रवर्धनका लागि निम्न
            ...
            <p className="mt-6">
              यसरी डुडुवा गाउँपालिकामा प्रसूती स्थानको अवस्थाको विश्लेषणले
