...
export const metadata: Metadata = {
  title: "डुडुवा गाउँपालिका प्रजनन् स्वास्थ्य | डिजिटल प्रोफाइल",
  description:
    "डुडुवा गाउँपालिकाको प्रजनन् स्वास्थ्य सम्बन्धी तथ्याङ्क: सुरक्षित मातृत्वको अवस्था, संस्थागत प्रसूति, गर्भवती स्वास्थ्य सेवा र सुत्केरी स्थान सम्बन्धी विस्तृत विवरण।",
  keywords: [
    "डुडुवा गाउँपालिका",
    "प्रजनन् स्वास्थ्य",
    "मातृ स्वास्थ्य",
...
const fertilityCategories = [
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा गर्भवती जाँच, संस्थागत प्रसूति, सुत्केरी सेवा र नवजात शिशु स्वास्थ्य सम्बन्धी सूचकहरूको विस्तृत विवरण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा महिलाहरूले सुत्केरी गराउने स्थानको वडागत विवरण र विश्लेषण।",
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="relative rounded-lg overflow-hidden">
          <Image
            ...
            alt="डुडुवा गाउँपालिका प्रजनन् स्वास्थ्य"
            width={1200}
            height={400}
        ...
        <div className="mt-6 px-2">
          <h1 className="text-4xl font-bold mb-3">
            डुडुवा गाउँपालिकाको प्रजनन् स्वास्थ्य
          </h1>
        </div>
        ...
        <section id="introduction">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              ...
              सूचकहरू हुन्। डुडुवा गाउँपालिकाको प्रजनन् स्वास्थ्य सम्बन्धी
        ...
        <section id="fertility-categories" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकाको प्रजनन् स्वास्थ्य सम्बन्धी विस्तृत
        ...
        <section id="improvement-strategies" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकामा प्रजनन् स्वास्थ्यको अवस्था सुधार गर्न
