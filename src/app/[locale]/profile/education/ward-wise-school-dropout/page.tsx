...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "डुडुवा गाउँपालिका विद्यालय छाड्ने कारण",
      "स्कूल ड्रपआउट",
      "वडागत शैक्षिक त्याग",
    ...
    const keywordsEN = [
      "duduwa Rural Municipality school dropout causes",
      "School dropout rate",
    ...
    // Create description
    const descriptionNP = `डुडुवा गाउँपालिकामा विद्यालय छाड्नुका कारणहरूको विश्लेषण। कुल ${localizeNumber(totalDropouts.toLocaleString(), "ne")} जनसंख्या मध्ये ${localizeNumber(economicDropoutPercentage, "ne")}% (${localizeNumber(economicDropouts.toLocaleString(), "ne")}) जनाले आर्थिक कारणले विद्यालय छोडेका छन्।`;

    const descriptionEN = `Analysis of school dropout causes in duduwa Rural Municipality. Out of a total of ${totalDropouts.toLocaleString()} dropouts, ${economicDropoutPercentage}% (${economicDropouts.toLocaleString()}) have left school for economic reasons.`;
    ...
    return {
      title:
        "विद्यालय छाड्ने कारणहरूको अवस्था | डुडुवा गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="विद्यालय छाड्ने कारणहरू - डुडुवा गाउँपालिका (School Dropout Causes - duduwa Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              डुडुवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको अवस्था
            </h1>
            ...
            <p>
              ...
              प्रणालीको सुधारका लागि महत्वपूर्ण छन्। यस खण्डमा डुडुवा
            ...
            <p>
              डुडुवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              डुडुवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(
                dropoutGroupPercentages.ECONOMIC.toFixed(2),
                "ne",
            ...
            <p>
              डुडुवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी डुडुवा गाउँपालिकामा विद्यालय छाड्ने कारणहरूको विश्लेषणले
