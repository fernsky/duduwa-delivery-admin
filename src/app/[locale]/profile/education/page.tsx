...
export const metadata: Metadata = {
  title: "डुडुवा गाउँपालिका शैक्षिक अवस्था | डिजिटल प्रोफाइल",
  description:
    "डुडुवा गाउँपालिकाको शैक्षिक अवस्था सम्बन्धी तथ्याङ्क: शैक्षिक स्तर, साक्षरता दर र विद्यालय छाड्ने कारणहरू सम्बन्धी विस्तृत विवरण।",
  keywords: [
    "डुडुवा गाउँपालिका",
    "शैक्षिक अवस्था",
    "शैक्षिक स्तर",
...
const educationCategories = [
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा जनसंख्याको शैक्षिक स्तरको वडागत वितरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा साक्षरताको अवस्थाको वडागत वितरण र विश्लेषण।",
  ...
  },
  {
    ...
    description:
      "डुडुवा गाउँपालिकामा विद्यार्थीहरूले विद्यालय छाड्नुका कारणहरूको वडागत विश्लेषण।",
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="relative rounded-lg overflow-hidden">
          <Image
            ...
            alt="डुडुवा गाउँपालिका शैक्षिक अवस्था"
            width={1200}
            height={400}
        ...
        <div className="mt-6 px-2">
          <h1 className="text-4xl font-bold mb-3">
            डुडुवा गाउँपालिकाको शैक्षिक अवस्था
          </h1>
        </div>
        ...
        <section id="introduction">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p>
              ...
              गर्दछ। डुडुवा गाउँपालिकाको शैक्षिक प्रोफाइलमा शैक्षिक स्तर,
        ...
        <section id="education-categories" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकाको शैक्षिक अवस्था सम्बन्धी विस्तृत जानकारीका
        ...
        <section id="improvement-strategies" className="my-8">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-6">
            ...
            <p>
              डुडुवा गाउँपालिकामा शैक्षिक अवस्था सुधार गर्न निम्न रणनीतिहरू
              अपनाउन सकिन्छ:
            </p>
