...
export function generateWardWiseAbsenteeEducationalLevelAnalysis(data: ProcessedWardWiseAbsenteeEducationalLevelData): string {
  ...
  analysisParts.push(
    `डुडुवा गाउँपालिकामा कुल ${convertToNepaliNumber(data.totalAbsenteePopulation)} विदेश गएका जनता रहेका छन् जसमा विभिन्न शैक्षिक स्तरका जनताहरू समावेश छन्। यी तथ्याङ्कले गाउँपालिकाको मानव पूँजी, शैक्षिक विकास र आर्थिक अवसरहरूको स्तरको विस्तृत चित्र प्रस्तुत गर्दछ। विदेश गएका जनताको शैक्षिक स्तरले न केवल स्थानीय शैक्षिक विकास मात्र देखाउँछ तर मानव पूँजीको गुणस्तर, आर्थिक अवसरहरूको आकर्षण र विकासको दिशालाई पनि संकेत गर्दछ।`
  );
