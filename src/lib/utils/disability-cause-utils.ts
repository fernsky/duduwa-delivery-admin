...
export function generateDisabilityCauseAnalysis(data: ProcessedDisabilityCauseData): string {
  ...
  analysis.push("नेपालको संविधान २०७२ ले अपाङ्गता भएका व्यक्तिहरूको अधिकार र सुरक्षालाई मौलिक अधिकारको रूपमा मान्यता दिएको छ र सरकारलाई तिनको पुनर्स्थापना, शिक्षा र रोजगारीको अवसर प्रदान गर्ने जिम्मेवारी दिएको छ। डुडुवा गाउँपालिकामा अपाङ्गताका कारणहरूको विश्लेषणले स्थानीय स्वास्थ्य चुनौतीहरू र तिनको समाधानका लागि आवश्यक नीतिगत दिशानिर्देशहरू प्रदान गर्दछ।");
