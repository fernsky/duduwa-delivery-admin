...
export function generateWardWiseMigratedHouseholdsAnalysis(data: ProcessedWardWiseMigratedHouseholdsData): string {
  ...
  analysisParts.push(
    `डुडुवा गाउँपालिकामा कुल ${convertToNepaliNumber(data.totalHouseholds)} सरुवा परिवार रहेका छन् जसमा विभिन्न स्थानबाट सरुवा भएका परिवारहरूको वितरण रहेको छ। यी तथ्याङ्कले गाउँपालिकाको जनसंख्या गतिशीलता, सामाजिक एकीकरण र आर्थिक विकासको विस्तृत चित्र प्रस्तुत गर्दछ। सरुवा परिवारहरूको वितरणले न केवल जनसंख्या परिवर्तन मात्र देखाउँछ तर सामाजिक संरचना, आर्थिक अवसर र विकासको प्रवृत्तिलाई पनि संकेत गर्दछ। यसले गाउँपालिकाको समग्र सामाजिक-आर्थिक परिवर्तन र भविष्यको दिशालाई प्रतिबिम्बित गर्दछ।`
  );
