...
export function generateCasteAnalysis(data: ProcessedCasteData): string {
  ...
  // Overall summary
  analysisParts.push(
    `डुडुवा गाउँपालिकामा कुल ${convertToNepaliNumber(data.totalPopulation)} जनाको जातिगत विविधता अत्यन्तै उल्लेखनीय छ। यहाँका बासिन्दाहरूले विभिन्न जातजातिहरूको प्रतिनिधित्व गरेका छन्, जसले गाउँपालिकाको सांस्कृतिक र सामाजिक समृद्धिलाई झल्काउँछ।`
  );
  ...
  analysisParts.push(
    `नेपालको संविधान २०७२ ले जातीय छुवाछूत र भेदभावको अन्त्य गर्ने संकल्प गरेको छ र समानुपातिक समावेशी सिद्धान्तका आधारमा समतामूलक समाजको निर्माण गर्ने नीति अपनाएको छ। यस संवैधानिक प्रावधानको प्रतिबिम्ब डुडुवा गाउँपालिकामा पनि देख्न सकिन्छ, जहाँ विभिन्न जातजातिहरूको सहअस्तित्व रहेको छ।`
  );
