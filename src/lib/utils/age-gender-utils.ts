...
export function generateAgeGenderAnalysis(data: ProcessedAgeGenderData): string {
  ...
  return (
    `डुडुवा गाउँपालिकाको जनसंख्याको उमेर र लिङ्गीय संरचनाले जटिल जनसांख्यिकीय परिदृश्य प्रकट गर्दै सामाजिक र आर्थिक योजनाको लागि महत्त्वपूर्ण निहितार्थहरू प्रस्तुत गर्दछ । ` +
