...
export function generateWardWiseHouseOwnershipAnalysis(data: ProcessedWardWiseHouseOwnershipData): string {
  ...
  analysisParts.push(
    `डुडुवा गाउँपालिकामा कुल ${convertToNepaliNumber(data.totalHouseholds)} घरपरिवार रहेका छन् जसमा विभिन्न प्रकारका घर स्वामित्वको वितरण रहेको छ। यी तथ्याङ्कले गाउँपालिकाको आर्थिक स्थिरता, सामाजिक समानता र विकासको स्तरको विस्तृत चित्र प्रस्तुत गर्दछ। घर स्वामित्वको वितरणले न केवल आर्थिक अवस्था मात्र देखाउँछ तर सामाजिक संरचना, विकासको प्रवृत्ति र भविष्यको दिशालाई पनि संकेत गर्दछ।`
  );
