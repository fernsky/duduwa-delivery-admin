...
export function generateDeathRegistrationAnalysis(data: ProcessedDeathRegistrationData): string {
  ...
  // Overall summary
  analysisParts.push(
    `डुडुवा गाउँपालिकामा कुल ${convertToNepaliNumber(data.totalDeaths)} मृतक दर्ता भएका छन् जसले गाउँपालिकाको जनसांख्यिकीय परिदृश्य र स्वास्थ्य स्थितिको महत्त्वपूर्ण जानकारी प्रदान गर्दछ।`
  );
