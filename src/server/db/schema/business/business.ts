...
export const business = pgTable("acme_duduwa_business", {
...
export const stagingBusiness = pgTable("staging_acme_duduwa_businesses", {
  // Primary identification
  id: text("id").primaryKey().notNull(),
  wardNo: integer("ward_no").notNull(),
  tenantId: text("tenant_id"),
...
export const businessEditRequests = pgTable("acme_duduwa_business_edit_requests", {
